...
%prep
%setup -q -n colorama-0.4.3
cd %{_builddir}/colorama-0.4.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1594747178
...
cp %{_builddir}/colorama-0.4.3/LICENSE.txt %{buildroot}/usr/share/package-licenses/colorama/151478b5f4a6291addb13da92ef3534597ed39a4
